...
async function main() {
    ...
    try {
        ...
        console.log("   Recovery Rate:", recoveryRate.toString(), "basis points (", Number(recoveryRate) / 100, "%)");
        console.log("   Recovery Fee:", recoveryFee.toString(), "basis points (", Number(recoveryFee) / 100, "%)");
        ...
        for (const victim of exampleVictims) {
            ...
            console.log(`   Has Recovered: ${status.hasRecoveredStatus}`);
            ...
            console.log(`   Recovery Fee: ${ethers.formatEther(status.recoveryFeeAmount)} ETH`);
