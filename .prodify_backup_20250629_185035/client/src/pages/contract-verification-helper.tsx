      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <Alert>
              <AlertDescription>
                <strong>Alternative Route - Remix IDE Verification:</strong><br/>
                ...
                >
                  Remix IDE <ExternalLink className="h-3 w-3" />
                </a><br/>
                <strong>Step 2:</strong> Create new file "ETHGRecovery.sol" and paste source code<br/>
                <strong>Step 3:</strong> Compile with Solidity v0.8.19<br/>
                <strong>Step 4:</strong> Go to "File Explorer" → Right-click compiled contract → "Verify on Etherscan"<br/>
                <strong>Step 5:</strong> Enter contract address: 0xfA7b8c553C48C56ec7027d26ae95b029a2abF247
              </AlertDescription>
            </Alert>
