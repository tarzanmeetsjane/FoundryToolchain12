...
export default function TokenLaunchPage() {
  ...
  const [ethgrAmount, setEthgrAmount] = useState("2817");
  const [calculatedPrice, setCalculatedPrice] = useState("0.355");
  const [totalValue, setTotalValue] = useState("704505.24");
